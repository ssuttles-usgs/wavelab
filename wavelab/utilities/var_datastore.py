"""
This module stores all of the variables and metadata to write pressure netCDF files
"""
...
class DataStore(object):
    ...
    def __init__(self, grouping):
        ...
        self.pressure_var = {
                             ...
                             'instrument_level_accuracy_in_meters': "",
                             }
    ...
    def send_data(self, ds):
        ...
        if self.pressure_qc_data is not None:
    ...
    def get_pressure_var(self, ds):
        ...
        if self.pressure_name is not None:
        ...
        for x in self.pressure_var:
            if self.pressure_var[x] is None:
                pressure.setncattr(x,'N/A')
            else:
    ...
    def get_time_duration(self):
        ...
        self.global_vars_dict["time_coverage_start"] = \
            uc.convert_ms_to_datestring(first_milli, pytz.utc)

        self.global_vars_dict["time_coverage_end"] = \
            uc.convert_ms_to_datestring(second_milli, pytz.utc)

        self.global_vars_dict["time_coverage_duration"] = \
            uc.get_time_duration(second_milli - first_milli)
