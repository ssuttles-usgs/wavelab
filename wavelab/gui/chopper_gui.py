#!/usr/bin/env python3
"""
Contains a GUI that shows the time series of the processed
sea or air pressure netCDF file and allows one to extract a
desired slice of the time series, often avoiding spurious
data at the beginning and/or end of the file.
"""
