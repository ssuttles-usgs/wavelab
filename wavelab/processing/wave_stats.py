#!/usr/bin/env python3
"""
Statistics calculations using power spectral density and trapezoidal
rule on spectral moments.
"""
import numpy as np
...
class Stats(object):
    ...
    @staticmethod
    def welch_power_spectrum(y,tstep):
    ...
    @staticmethod
    def peak_wave_period(spec, freq, t, depth):
    ...
    @staticmethod
    def significant_wave_period(spec, freq, depth, tstep):
    ...
    @staticmethod
    def psd_confidence_intervals(PSD, df, ci):
